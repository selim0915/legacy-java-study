				...
				<div class="form-row">
					...
					<div class="form-group col-md-6">
						<label for="">Name</label> <input type="text" class="form-control"
							id="mname" name="mname" placeholder="이름">
					</div>
					<div class="form-group col-md-6">
						<label for="">Age</label> <input type="text" class="form-control"
							id="age" name="age" maxlength="3" placeholder="나이">
					</div>
				</div>
						...
						<label for="form-check-label">Gender</label><br>
							<div class="form-check form-check-radio form-check-inline">
								<label class="form-check-label"> <input
									...
									value="남자"> 남자 <span class="form-check-sign"></span></label>
							</div>
							<div class="form-check form-check-radio form-check-inline">
								<label class="form-check-label"> <input
									class="form-check-input" type="radio" name="gender" id="gender"
									value="여자"> 여자 <span class="form-check-sign"></span></label>
							</div>
					</div>
				</div>
				<br>
	
					<button class="btn btn-primary animation-on-hover" type="submit">Create
						your account</button>
